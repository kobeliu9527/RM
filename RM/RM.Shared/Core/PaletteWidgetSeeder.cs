        ...
        static PaletteWidgetSeeder()
        {
            ...
            _paletteWidgetList = new List<PaletteWidgetDto>()
            {
                ...
                new PaletteWidgetDto()
                {
                    ...
                    Visible = true,
                    Props=new Dictionary<string, Property>(){
                        {"DisplayText",new Property(){  StringValue="请选择", PType= PType.String}},
                        {"ShowLabel",new Property(){  StringValue="True", PType= PType.Bool} },
                        {"Text",new Property(){  StringValue="请输入...", PType= PType.String} },
                        {"Color",new Property(){  StringValue="None", PType= PType.SingleColor} },
                        {"Value",new Property(){  StringValue="北京", PType= PType.String} },
                        {"StoreName",new Property(){  StringValue="SelectDemo", PType= PType.String} },
                ...
                new PaletteWidgetDto()
                {
                    ...
                    Visible = true,
                    Props=new Dictionary<string, Property>(){
                        {"DisplayText",new Property(){  StringValue="111"} },
                        {"ShowLabel",new Property(){  StringValue="True", PType= PType.Bool} },
                        {"Text",new Property(){  StringValue="True", PType= PType.String} },
                        {"Color",new Property(){  StringValue="None", PType= PType.SingleColor} },
                        {"BoolVal",new Property(){BoolVal=false,  StringValue="None", PType= PType.Bool} }
                    },
