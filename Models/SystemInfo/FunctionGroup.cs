...
namespace Models.SystemInfo
{
    ...
    public class FunctionGroup : EntityBase
    {
        ...
        [Navigate(typeof(ModuleAndFunctionGroup), nameof(ModuleAndFunctionGroup.FunctionGroupId), nameof(ModuleAndFunctionGroup.ModuleId))]
        public List<Module>? ModuleGroups { get; set; }
    }
}
