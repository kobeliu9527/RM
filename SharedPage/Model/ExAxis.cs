...
namespace SharedPage.Model
{
    ...
    public class ExAxis
    {
        ...
        /// 参见<see cref="Sys.axisLine"/>
        /// </summary>
        [DisplayName("是否显示")]public JsVal? show { get; set; }
        /// <summary>
        /// 表示这个轴在哪个grid上,默认第一个
        /// </summary>
        [DisplayName("是否显示"),Description("表示这个轴在哪个grid上,默认第一个")] public JsVal? gridIndex { get; set; }
        /// <summary>
        ...
        ///注：若未将 xAxis.axisLine.onZero 设为 false , 则该项无法生效
        /// </summary>
        [DisplayName("轴线偏移"), Description("")] public JsVal? offset { get; set; }
        /// <summary>
        /// 类型
        /// </summary>
        ...
        /// 坐标轴名称。
        /// </summary>
        [DisplayName("轴名称")]public JsVal? name { get; set; }
        /// <summary>
        /// 坐标轴名称显示位置。
        /// </summary>
